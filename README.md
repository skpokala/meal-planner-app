...
curl -L -H "Accept: application/json" "https://<sitename>/api/location/search?q=1600+Amphitheatre+Parkway"

# Reverse geocoding example
curl -L -H "Accept: application/json" "https://<sitename>/api/location/reverse-geocode?lat=37.4221&lng=-122.0841"
```
